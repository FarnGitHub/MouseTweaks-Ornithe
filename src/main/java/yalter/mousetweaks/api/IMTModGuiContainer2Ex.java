...
public interface IMTModGuiContainer2Ex {
	 ...
	 */
	List<InventorySlot> MT_getSlots();
	 ...
	 */
	InventorySlot MT_getSlotUnderMouse();
	 ...
	 */
	boolean MT_isCraftingOutput(InventorySlot slot);
	 ...
	 */
	boolean MT_isIgnored(InventorySlot slot);
	 ...
	 */
	void MT_clickSlot(InventorySlot slot, int mouseButton, boolean shiftPressed);
}
